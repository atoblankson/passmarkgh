      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
          {steps.map((step) => (
            <div
              key={step.stepNumber}
              className="relative rounded-3xl border border-slate-200/90 bg-white p-7 shadow-xs hover-lift transition-all flex flex-col justify-between group hover:border-blue-300"
            >
              <div>
                {/* Step Number Badge */}

      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 items-stretch">
          ...
          <ScrollReveal variant="fade-left">
            <Card className="relative overflow-hidden border-slate-200 bg-white rounded-3xl p-6 sm:p-8 flex flex-col justify-between shadow-sm hover-lift transition-all h-full">
              <div>
                {/* Header */}
          ...
          <ScrollReveal variant="fade-right" delay={100}>
            <Card className="relative overflow-hidden border-2 border-brand-blue bg-blue-50/30 rounded-3xl flex flex-col justify-between shadow-md hover-lift transition-all p-0 h-full">
